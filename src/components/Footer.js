    ...
    return (
        <footer className="bg-white dark:bg-gray-900 mt-auto">
            <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 Jonathan Wijaya. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                    <a href="https://www.instagram.com/jonnwijaya/" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="https://www.github.com/jonnwijaya" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="https://www.linkedin.com/in/jonnwijaya/" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
